...
def execute_dispatch(data):
    ...
    reason = data.get("reason", "Tow")
    pickup = data.get("pickup_location", "Unknown")
    ...
    try:
        with NovaAct(
            ...
            - RULE 1: If you type into a dropdown (like Reason or Vehicle) and the exact match isn't there, select the closest match.
            ...
            3. Name: {customer}
            4. Phone: {phone}
            5. Reason: Select EXACTLY '{reason}' from the Reason dropdown.
            6. Vehicle Information: Enter '{vehicle}' into the Vehicle Make and Vehicle Model fields.
